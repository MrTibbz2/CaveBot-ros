...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dwb_msgs
max_serialized_size_key_GetCriticScore_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
size_t get_serialized_size_key(
  ...
  size_t current_alignment);
size_t
max_serialized_size_key_CriticScore(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dwb_msgs
max_serialized_size_key_GetCriticScore_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: score
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        dwb_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_CriticScore(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
// functions for dwb_msgs::srv::GetCriticScore_Request already declared above

// functions for dwb_msgs::srv::GetCriticScore_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dwb_msgs
cdr_serialize(
  const dwb_msgs::srv::GetCriticScore_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dwb_msgs::srv::GetCriticScore_Event & ros_message)
{
  // Member: info
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dwb_msgs
max_serialized_size_GetCriticScore_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        dwb_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_GetCriticScore_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        dwb_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_GetCriticScore_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = dwb_msgs::srv::GetCriticScore_Event;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dwb_msgs
max_serialized_size_key_GetCriticScore_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        dwb_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_GetCriticScore_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        dwb_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_GetCriticScore_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const dwb_msgs::srv::GetCriticScore_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<dwb_msgs::srv::GetCriticScore_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetCriticScore_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const dwb_msgs::srv::GetCriticScore_Event *>(
...
static size_t _GetCriticScore_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetCriticScore_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetCriticScore_Event__callbacks = {
  "dwb_msgs::srv",
...
static rosidl_message_type_support_t _GetCriticScore_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetCriticScore_Event__callbacks,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_dwb_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<dwb_msgs::srv::GetCriticScore_Event>()
{
  return &dwb_msgs::srv::typesupport_fastrtps_cpp::_GetCriticScore_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dwb_msgs, srv, GetCriticScore_Event)() {
  return &dwb_msgs::srv::typesupport_fastrtps_cpp::_GetCriticScore_Event__handle;
}
...
static const rosidl_service_type_support_t _GetCriticScore__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetCriticScore__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<dwb_msgs::srv::GetCriticScore_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<dwb_msgs::srv::GetCriticScore_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<dwb_msgs::srv::GetCriticScore_Event>(),
  &::rosidl_typesupport_cpp::service_create_event_message<dwb_msgs::srv::GetCriticScore>,
  &::rosidl_typesupport_cpp::service_destroy_event_message<dwb_msgs::srv::GetCriticScore>,
