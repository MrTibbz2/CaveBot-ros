...
#define NODE_MAIN_LOGGER_NAME "image_flip_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libimage_flip.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<image_rotate::ImageFlipNode>";
