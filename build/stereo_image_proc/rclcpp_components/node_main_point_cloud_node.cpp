...
#define NODE_MAIN_LOGGER_NAME "point_cloud_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libstereo_image_proc.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<stereo_image_proc::PointCloudNode>";
