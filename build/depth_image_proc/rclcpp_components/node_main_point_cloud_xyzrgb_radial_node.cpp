...
#define NODE_MAIN_LOGGER_NAME "point_cloud_xyzrgb_radial_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libdepth_image_proc.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<depth_image_proc::PointCloudXyziRadialNode>";
