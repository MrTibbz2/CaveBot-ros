...
#define NODE_MAIN_LOGGER_NAME "point_cloud_xyz_radial_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<depth_image_proc::PointCloudXyzRadialNode>";
