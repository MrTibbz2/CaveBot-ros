...
#define NODE_MAIN_LOGGER_NAME "rectify_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "librectify.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<image_proc::RectifyNode>";
