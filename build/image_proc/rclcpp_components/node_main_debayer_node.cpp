...
#define NODE_MAIN_LOGGER_NAME "debayer_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libdebayer.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<image_proc::DebayerNode>";
