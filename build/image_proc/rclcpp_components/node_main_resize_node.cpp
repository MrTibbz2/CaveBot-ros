...
#define NODE_MAIN_LOGGER_NAME "resize_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libresize.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<image_proc::ResizeNode>";
