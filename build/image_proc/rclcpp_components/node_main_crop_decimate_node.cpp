...
#define NODE_MAIN_LOGGER_NAME "crop_decimate_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libcrop_decimate.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<image_proc::CropDecimateNode>";
