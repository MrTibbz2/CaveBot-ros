...
#define NODE_MAIN_LOGGER_NAME "track_marker_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtrack_marker.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<image_proc::TrackMarkerNode>";
