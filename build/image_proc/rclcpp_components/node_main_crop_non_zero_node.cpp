...
#define NODE_MAIN_LOGGER_NAME "crop_non_zero_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libcrop_non_zero.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<image_proc::CropNonZeroNode>";
